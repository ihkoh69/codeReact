...
const ResultModal = ({title, content, callbackFn}) => {
    ...
    useEffect(()=>{
        console.log(title, content, callbackFn);
    },[title,content, callbackFn]);
  return (
  ...
  ></div> */}
        ...
        <div className='absolute bg-white shadow darg:bg-gray-700 opacity-100 w-1/4 rounded mt-10 mb-10 px-6 min-w-[600px]'>
